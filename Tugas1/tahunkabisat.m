...
% Last Modified by GUIDE v2.5 07-Apr-2021 23:18:26
...
function inputKabisat_Callback(hObject, eventdata, handles)
% hObject    handle to inputKabisat (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of inputKabisat as text
%        str2double(get(hObject,'String')) returns contents of inputKabisat as a double



% --- Executes during object creation, after setting all properties.
function inputKabisat_CreateFcn(hObject, eventdata, handles)
% hObject    handle to inputKabisat (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
input = get(handles.inputKabisat, 'string');
angka=str2num(input);
hasil="bukan kabisat";
if mod(angka,4)==0 && mod(angka,100)~=0  | mod(angka,400)==0
    hasil="kabisat"; 
end

set(handles.hasilKabisat, 'string', (hasil))


% --- Executes on button press in pindah.
function pindah_Callback(hObject, eventdata, handles)
% hObject    handle to pindah (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
guidata(balok);
